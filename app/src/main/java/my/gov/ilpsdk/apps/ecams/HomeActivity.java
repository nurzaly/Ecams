        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.card_hartamodal:
                    AssetListActivity.navigate(HomeActivity.this, Constant.URL_ASSETS_JENIS+"?jenis_aset=H&nama="+nama, "Senarai Harta Modal");
                    break;
                case R.id.card_inventori:
                    AssetListActivity.navigate(HomeActivity.this, Constant.URL_ASSETS_JENIS+"?jenis_aset=I&nama="+nama, "Senarai Inventori");
                    break;
...
//    }
                ...
                .getAsObjectList(Assets.class, new ParsedRequestListener<List<Assets>>() {
                    ...
                    public void onResponse(List<Assets> response) {
                        ...
                        if(response.size() == 1){
                            ...
                            AssetsDetailsActivity.navigate((AppCompatActivity) HomeActivity.this, response.get(0));
                        }
    ...
    private void searchAssets(String search_key){
        AssetListActivity.navigate(HomeActivity.this, Constant.URL_SEARCH_ASSETS+"?search_key="+search_key, "Senarai Aset");
    }
}
